...
exports.ordersPdfTemplate = ordersPdfTemplate;
...
function ordersPdfTemplate(orders, options = {}) {
    const periodo = options.data_inicio && options.data_fim
...
//# sourceMappingURL=ordersPdf.template.js.map